...
public class RawDataService {
    private static final Logger s_logger = Logger.getLogger(RawDataService.class);
    @Context
    ...
    public String findByConditionLimt(int limit, BasicDBObject querycondition) {
        String response;
        try {
            List<DBObject> resultlist = RawDataDAOImpl.getRawDataDAOInstance().queryListByObjectWithLimitAndSort(querycondition, limit, new Object[]{"CreationDate", Integer.valueOf(-1)});
